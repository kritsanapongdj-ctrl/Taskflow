      ...
      return (
        <div key={u.id} className="animate-fade-in-up flex-1 w-full bg-[#08080c] relative overflow-hidden flex flex-col md:flex-row shadow-[inset_0_0_100px_rgba(0,0,0,0.8)] rounded-xl h-full min-h-[600px]">
           ...
           <div className="w-full md:w-1/2 p-6 md:p-10 z-10 flex flex-col justify-center border-r border-white/10 relative h-full overflow-y-auto hide-scrollbar">
              ...
              <div className="animate-in fade-in slide-in-from-left-8 duration-700 mt-auto mb-auto h-full flex flex-col justify-center">
                <div className="mb-6">
                  <div className="relative flex items-center justify-center w-16 h-16 md:w-20 md:h-20 group">
